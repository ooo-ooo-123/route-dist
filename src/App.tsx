import React, { useState, useEffect } from 'react'; // 导入 useState
...
import { ThemeProvider, useTheme } from './context/ThemeContext'; // 引入 Provider
...
const App: React.FC = () => {
  const [blogTitle] = useState<string>("我的技术博客 特别牛波1!");
