...
import myAvatar from '../assets/myphoto.png';
...
const Sidebar: React.FC<SidebarProps> = ({onSubscribe}) =>{
 ...
 const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    <aside className={styles.sidebar}>
      ...
      <section className={styles.widget}>
        ...
        <div className={styles.authorInfo}>
          ...
          />
          <p>⚡ 蕫鬨前端开发爱好者，深耕 React / TypeScript 生态，正在朝着全栈方向进阶。。</p>
        </div>
      </section>
  ...
  <ul className={styles.socialLinks}>
    <li><a href="#" aria-label="GitHub"><span>💻</span> GitHub</a></li>
    <li><a href="#" aria-label="Twitter"><span>🐦</span> Twitter</a></li>
    <li><a href="#" aria-label="LinkedIn"><span>💼</span> LinkedIn</a></li>
  </ul>
</section>
